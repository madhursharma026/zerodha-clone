...
export default function RightSidebar() {
  ...
  return (
    // <Col className="px-4 py-3" style={{ overflowY: 'scroll', height: height }}>
    <Col className={`px-4 py-3 ${styles.scrollContainer}`}>
      ...
      <div className="row">
        <div className="col-md-6 row">
          ...
          <div className={`col-sm-5 col-12  ${styles.borderEndOnlySm}`}>
            ...
            <span className="text-muted mediumFontSize">Margin available</span>
          </div>
      ...
      <div className="row">
        <div className="col-xl-7 col-md-8">
          <img src="chart.png" alt="#ImgNotFound" className="img-fluid" />
        </div>
